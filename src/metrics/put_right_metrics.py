...
def test_put_right_metrics():
    ...
    with open("../../output/metrics_output/metrics_final_only_wrong_urls_fixed.csv") as csv_file:
    ...
    input_csv = "../../output/metrics_output/metrics_final_with_wrong_urls.csv"
    output_csv = "../../output/metrics_output/metrics_final.csv"
