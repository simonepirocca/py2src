...
def test_match_packages():
    ...
    with open('../../outputs/metrics_output/packages_asc.csv') as csv_file:
    ...
    with open('../../outputs/vulns_output/snyk_pip_vulns.csv') as csv_file:
        csv_reader = csv.reader(csv_file, delimiter=';')
        line_count = 0
        for row in csv_reader:
            if line_count > 0:
    ...
    with open("../../outputs/vulns_output/matching_vulns.csv", mode='w') as csv_file:
...
'GitHub Commit', 'GitHub Release', 'GitHub Release Tag', 'GitHub Additional Information', 'GitHub PR', 'GitHub Issue', 'NVD'])
    ...
    with open("../../outputs/vulns_output/matching_packages.csv", mode='w') as csv_file:
        vulns_writer = csv.writer(csv_file, delimiter=';')
