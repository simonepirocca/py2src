...
def test_find_package_from_vuln():
    ...
    with open('../../outputs/vulns_output/packages_with_vuln_commit.csv') as csv_file:
    ...
    with open("../../outputs/vulns_output/clone_dir_from_commit_hash.csv", mode='w') as csv_file:
