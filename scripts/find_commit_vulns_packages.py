...
output_file = "../output/vulns_output/packages_with_vuln_commit.csv"
urls = {}
commit_packages = []
...
# Print out the number of packages whose vulns have a unique commit link
# and store the information into a csv file
logger.info(f"Commit packages: {tot_commit_packages}")
